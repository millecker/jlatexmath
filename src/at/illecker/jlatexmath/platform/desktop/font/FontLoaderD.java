 ...
 * 
 */
package at.illecker.jlatexmath.platform.desktop.font;
...
public class FontLoaderD implements FontLoader {
  ...
  public Font loadFont(Object base, String name) throws ResourceParseException {
    ...
    try {
      ...
      /**
       * The following fails under java 1.5 graphicEnv.registerFont(f); dynamic
       * load then
       */
      if (shouldRegisterFonts) {
        try {
          Method registerFontMethod = graphicEnv.getClass()
              .getMethod("registerFont", new Class[] { java.awt.Font.class });
          if ((Boolean) registerFontMethod.invoke(graphicEnv,
              new Object[] { f }) == Boolean.FALSE) {
      ...
      throw new XMLResourceParseException("FontLoader" + ": FontLoader '" + name
